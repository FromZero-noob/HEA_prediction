...
AZURE_OPENAI_BASE_URL = "https://eureka1.openai.azure.com/" # url
AZURE_API_VERSION =  "2024-12-01-preview" # version such as "2024-12-01-preview"
os.environ["AZURE_API_KEY"] = AZURE_OPENAI_API_KEY
os.environ["AZURE_API_BASE"] = AZURE_OPENAI_BASE_URL
os.environ["AZURE_API_VERSION"] = AZURE_API_VERSION
model = LiteLlm(model="azure/gpt-4o") 
mcp = CalculationMCPServer("Demo", port=50001)
'''
mcp = FastMCP("HEA_assistant")
...
def HEA_predictor(name:List[str])->List[str]:
    ...
    Tm_MODEL_PATH =        os.getenv("SCALER_Tm_PATH","models/Tm_predict_model_xgb.pkl")
    #loadmodels
