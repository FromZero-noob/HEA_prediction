...
#env
HMIX_DATA_PATH =       os.getenv("HMIX_DATA_PATH", "HEA_assistant_agent_MatMaster/data/binary_Hmix.csv")
SCALER_TYPE_PATH =     os.getenv("SCALER_TYPE_PATH", "HEA_assistant_agent_MatMaster/models/feats_scaler_type.pkl")
SCALER_STRUC_PATH =    os.getenv("SCALER_STRUC_PATH","HEA_assistant_agent_MatMaster/models/feats_scaler_struc.pkl")
SCALER_Tm_PATH =       os.getenv("SCALER_Tm_PATH","HEA_assistant_agent_MatMaster/models/feats_scaler_Tm.pkl")
TYPE_MODEL_PATH =      os.getenv("TYPE_MODEL_PATH", "HEA_assistant_agent_MatMaster/models/Type_predict_model_XGB.pkl")
STRUCTURE_MODEL_PATH = os.getenv("STRUCTURE_MODEL_PATH", "HEA_assistant_agent_MatMaster/models/Structure_predict_model.pkl")
Tm_MODEL_PATH =        os.getenv("Tm_MODEL_PATH","HEA_assistant_agent_MatMaster/models/Tm_predict_model_xgb.pkl")
